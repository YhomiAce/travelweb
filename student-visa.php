                    ...
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span cmt-bgcolor-grey mt_80 pt-60 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-form with-title">
                            ...
                            <form id="immigration_form" class="immigration_form wrap-form clearfix" method="post" novalidate="novalidate" action="#">
                                <label>
                                    <span class="text-input"><input name="name2" type="text" value="" placeholder="Your" required="required"></span>
                                </label>
                                <label>
                                    <span class="text-input"><input name="phone2" type="text" value="" placeholder="Phone" required="required"></span>
                                </label>
                                <label>
                                ...
                                <label>
                                    <span class="text-input"><textarea name="message2" rows="4" placeholder="Message" required="required"></textarea></span>
                                </label>
