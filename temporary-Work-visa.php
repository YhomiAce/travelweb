                    ...
                    <div class="col-lg-4 ttm-col-bgcolor-yes cmt-bg cmt-left-span cmt-bgcolor-grey mt_80 pt-60 mb_80 pb-60 res-991-mt-0 res-991-pt-0 widget-area sidebar-left">
                        ...
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                <li class="<?= (basename($_SERVER['PHP_SELF']) == 'business-visa.php') ? "active" : "" ;?>"><a href="business-visa.php">Business Visa</a></li>
                                <li class="<?= (basename($_SERVER['PHP_SELF']) == 'diplomatic-Offical-visa.php') ? "active" : "" ;?>"><a href="diplomatic-Offical-visa.php">Diplomatic & Offical Visa</a></li>
                                <li class="<?= (basename($_SERVER['PHP_SELF']) == 'skilled-worker-visa.php') ? "active" : "" ;?>"><a href="skilled-worker-visa.php">Skilled Worker Visa</a></li>
                                <li class="<?= (basename($_SERVER['PHP_SELF']) == 'student-visa.php') ? "active" : "" ;?>"><a href="student-visa.php">Student Visa</a></li>
                                <li class="<?= (basename($_SERVER['PHP_SELF']) == 'temporary-Work-visa.php') ? "active" : "" ;?>"><a href="temporary-Work-visa.php">Temporary Work Visa</a></li>
                                <li class="<?= (basename($_SERVER['PHP_SELF']) == 'visitor-visa.php') ? "active" : "" ;?>"><a href="visitor-visa.php">Visitor Visa</a></li>
                            </ul>
                        </aside>
                        ...
                        <aside class="widget widget-form with-title">
                            ...
                            <form id="immigration_form" class="immigration_form wrap-form clearfix" method="post" action="#">
                                <label>
                                    <span class="text-input"><input name="name2" type="text" value="" placeholder="Your" required></span>
                                </label>
                                <label>
                                    <span class="text-input"><input name="phone2" type="text" value="" placeholder="Phone" required></span>
                                </label>
                                <label>
                                ...
                                <label>
                                    <span class="text-input"><textarea name="message2" rows="4" placeholder="Message" required></textarea></span>
                                </label>
                                <button class="submit inquiry cmt-btn cmt-btn-size-md cmt-btn-shape-rounded cmt-btn-style-fill cmt-btn-color-skincolor" name="inquiry" type="submit">Send A Message</button>
                            </form>
                        </aside>
                    </div>
